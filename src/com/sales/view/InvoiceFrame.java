...
import com.sales.controller.Invoicelistener;
...
public class InvoiceFrame extends javax.swing.JFrame {
    ...
    private Invoicelistener controller = new Invoicelistener(this);
    private Invoice_Header_TableModel invoicesTableModel;
    ...
    public void setInvoices(ArrayList<Invoice_Header> invoices) {
     ...
     public Invoice_Header_TableModel getInvoicesTableModel() {
         if (invoicesTableModel == null) {
            invoicesTableModel = new Invoice_Header_TableModel(getInvoices());
        }
        return invoicesTableModel;
    }

    public void setInvoicesTableModel(Invoice_Header_TableModel invoicesTableModel) {
    ...
    public Invoicelistener getController() {
        return controller;
    }
